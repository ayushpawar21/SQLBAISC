--[Stocky HotFix Version]=371
Delete from Versioncontrol where Hotfixid='371'
INSERT INTO VersionControl(HotFixId,VersionNo,FixType,FixedOn,HotFixReleasedOn,VersionReleasedOn,ReplacedOn,ChangesDone) 
values('371','2.0.0.5','D','2011-04-04','2011-04-04','2011-04-04',convert(varchar(11),getdate()),'Parle;Major:-Akso Nobel CRs;Minor:Bug Fixing')
GO

DELETE FROM APPTITLE
INSERT INTO AppTitle SELECT 'CoreStocky 371' ,'371'
GO

--SRF-Nanda-225-001-From Boo
...
--SRF-Nanda-225-002-From Boo

DELETE FROM RptDetails WHERE RptId=222 and Slno=3
INSERT INTO RptDetails
SELECT 222,3,'Retailer',-1,'','RtrId,RtrCode,RtrName','Retailer...','',1,'',3,1,0,
'Press F4/Double Click to select Retailer',0
GO
DELETE FROM RptExcelHeaders WHERE RptId=222
INSERT INTO RptExcelHeaders
SELECT 222,1,'Description','Description',1,0
UNION ALL
SELECT 222,2,'RtrId','RtrId',0,0
UNION ALL
SELECT 222,3,'RtrCode','RtrCode',0,0
UNION ALL
SELECT 222,4,'RtrName','RtrName',0,0
UNION ALL
SELECT 222,5,'DocRefNo','Doc.Ref.Number',1,0
UNION ALL
SELECT 222,6,'Date','Date',1,0
UNION ALL
SELECT 222,7,'Debit','Debit',1,0
UNION ALL
SELECT 222,8,'Credit','Credit',1,0
UNION ALL
SELECT 222,9,'Balance','Balance',1,0
UNION ALL
SELECT 222,10,'TransactionDet','Cheque.No/Ref.No/Trans Details',1,0
UNION ALL
SELECT 222,11,'ChequeorDueDate','Cheque/Due',1,0
UNION ALL
SELECT 222,12,'SeqNo','SeqNo',0,0
UNION ALL
SELECT 222,13,'UserId','UserId',0,0
GO
IF EXISTS (SELECT * FROM SYSOBJECTS WHERE Xtype='P' and Name='Proc_RetailerAccountStment')
...
-- EXEC Proc_RetailerAccountStment '2011-04-04','2011-04-04',0

--SELECT * FROM @TempRetailerAccountStatement WHERE RtrId=4
...
if not exists (select * from hotfixlog where fixid = 371)
insert into hotfixlog(fixid,fixtype,releasedon,fixedon,fixedby,errorsfixed) values
(371,'D','2011-04-04',getdate(),1,'Core Stocky Service Pack 371')
